...
import com.andriod.deja_vu.PeopleHelper;
...
public class GoogleSignInActivity extends AppCompatActivity implements GoogleApiClient.OnConnectionFailedListener, GoogleApiClient.ConnectionCallbacks, View.OnClickListener {
    ...
    class PeoplesAsync extends AsyncTask<String, Void, List<String>> {
        ...
        protected List<String> doInBackground(String... params) {
            ...
            try {
                People peopleService = PeopleHelper.setUp(GoogleSignInActivity.this, params[0]);
        ...
        protected void onPostExecute(List<String> nameList) {
            for (String s: nameList) {
                Log.d("This person's friend", s);
            }
            Set<String> set = new HashSet<>();
            set.addAll(nameList);
            SharedPreferences sharedPreferences = getSharedPreferences("friends", MODE_PRIVATE);
